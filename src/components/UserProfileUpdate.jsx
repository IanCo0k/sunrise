...
const UserProfileUpdate = () => {
  ...
  return (
    <div>
      <Navbar />
      <div className="bg-gradient-to-r from-yellow-300 to-red-500 min-h-screen text-gray-800">
        <div className="max-w-[750px] min-h-screen flex flex-col pt-[120px] align-middle mx-auto px-4 py-8">
          ...
          <form onSubmit={handleUpdateProfile} className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                type="text"
                id="displayName"
                className="block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 px-4 py-2"
